...
commands+=("./pythia8_simple_eec.py --py-cmnd pythia_pp_5TeV_nPDF.cmnd --jet-pt-min 20. --charged --py-pthatmin 20. --py-seed 123456 -o pcone_bg_pPb.root --nev ${nev} 2>&1 | tee pcone_bg_pPb.log")
